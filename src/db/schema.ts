...
export const clientConfigs = pgTable('client_configs', {
  ...
  bookingLeadHours: integer('booking_lead_hours').default(2),
  bookingHorizonDays: integer('booking_horizon_days').default(14),
...
export const appointments = pgTable('appointments', {
  ...
  actionTokenExpiresAt: timestamp('action_token_expires_at'),
  ...
  clientStatusIdx: index('appt_client_status_idx').on(t.clientId, t.status),
  clientTimeIdx: index('appt_client_time_idx').on(t.clientId, t.startTime),
  actionTokenIdx: index('appt_action_token_idx').on(t.actionToken),
}));
